...
on the Flickr8K dataset~\cite{hodosh2013framing} beyond just its
partition. Flickr8K was originally introduced by Hodosh et al.\ for
...
pairs in total. Compared to other commonly used image captioning
...
corpus, and we treat it the same way. Despite
