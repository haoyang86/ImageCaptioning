...
def save_checkpoint(
    ...
    checkpoint = {
        ...
        "config": {
            ...
            # M2 LSTM + Attention settings
            "LSTM_Attention": cfg.LSTM_Attention,
            ...
            # Shared decoder / training settings
            "dropout": cfg.dropout,
            "max_len": cfg.max_len,

            # Encoder settings
            "encoder_dim": cfg.encoder_dim,
            "encoder_spatial_size": cfg.encoder_spatial_size,
...
def main():
    ...
    if optimizer_type == "adam":
        ...
        raise ValueError(
            f"Unsupported optimizer_type: {cfg.optimizer_type}. "
            "Choose 'Adam' or 'AdamW'."
        )

    print("Optimizer:", cfg.optimizer_type)
    ...
    # Save the plot
    plot_path = plot_dir / f"{cfg.experiment_name}_loss_plot.png"
