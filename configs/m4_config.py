# ==========================================
# M4 Configuration
# CNN Global Encoder + Transformer Decoder
# (decoder-only comparison vs M1 and M3)
# ==========================================
...
if embedding_type == "random":
    experiment_name = "m4_random"

elif embedding_type == "pretrained_frozen":
    experiment_name = "m4_glove_frozen"

elif embedding_type == "pretrained_finetune":
    experiment_name = "m4_glove_finetune"
...
log_dir = f"outputs/logs/M4/{experiment_name}"
train_log_name = "train_log.txt"

prediction_dir = f"outputs/predictions/M4/{experiment_name}"
