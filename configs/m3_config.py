...
if embedding_type == "random":
    experiment_name = "m3_random"

elif embedding_type == "pretrained_frozen":
    experiment_name = "m3_glove_frozen"

elif embedding_type == "pretrained_finetune":
    experiment_name = "m3_glove_finetune"
...
log_dir = f"outputs/logs/M3/{experiment_name}"
train_log_name = "train_log.txt"

prediction_dir = f"outputs/predictions/M3/{experiment_name}"
